...
[[footer]]
		...
		$this->TEMPLATES['searchbar'] = "<div align='center'>
<form name='whois_search' method='POST' action='[[site-url]]whois.php'>
<input type='hidden' name='page' value='WhoisSearch'>
<table>
<tr>
<td>
<div style=\"margin-top: 15px;\">http://www.<input type='text' name='domain' value='[[user-domain]]'>
 <div align=\"right\">
   <small>(<a href=\"[[site-url]]whois.php?page=MultipleWhoisSearch\">Check Multiple Domains</a>)</small>
 </div>
</div>
