...
class EP_Dev_Whois_Config
{
	...
	function EP_Dev_Whois_Config()
	{
		...
		$this->SCRIPT['TLD_DISPLAY']['num_rows'] = 1;
		$this->SCRIPT['TLD_DISPLAY']['num_columns'] = 7;
		$this->SCRIPT['TLD_DISPLAY']['include'] = "com, net, org, us, biz, info, tv";
...
";
		...
		$this->SCRIPT['copyright'] = false;
		$this->SCRIPT['absolute_path'] = "";
		$this->SCRIPT['version'] = "2.22";

		$this->SCRIPT['SITE']['title'] = "Domain name search";
		...
		$this->NAMESERVERS['whois.net.au']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.net.au']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.net.au']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.nic.mx']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.mx']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.mx']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.nomination.net']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nomination.net']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nomination.net']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['das.eu']['enabled'] = true;
		$this->NAMESERVERS['das.eu']['keyword'] = "Status: FREE";
		$this->NAMESERVERS['das.eu']['format'] = "get 1.0 [[DOMAIN]]";
		$this->NAMESERVERS['das.eu']['limit_format'] = "get 1.0 [[DOMAIN]]";
		$this->NAMESERVERS['das.eu']['limit_keyword'] = "Status: FREE";
		$this->NAMESERVERS['das.eu']['timeout'] = 30;
		$this->NAMESERVERS['das.eu']['extensions'] = "eu";
		$this->NAMESERVERS['das.eu']['extensions_disabled'] = "";
		$this->NAMESERVERS['das.eu']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['das.eu']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['das.eu']['advanced_custom_query_address'] = "[[SERVER]]:4343";
